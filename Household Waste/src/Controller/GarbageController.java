...
import Model.GarbageInfo;
import Model.GarbagePoint;
import java.time.LocalDateTime;
import java.util.ArrayList;

public class GarbageController extends GarbageInfo {
    ...
    public GarbageController(int[] gws) {
    ...
    public void goHome() {
        System.out.printf("Total Cost is %.0f VND", calculateTotalCost());
    }
}
